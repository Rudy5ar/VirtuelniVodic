    ...
    <div class="container">
        ...
        <table>
        	...
        	<tr>
        		...
        		<td><input type="number" name="geografskaSirina" value="${predmet.geografskaSirina}"></td>
        	</tr>
        	<tr>
        		<td>Geografska duzina</td>
        		<td><input type="number" name="geografskaDuzina" value="${predmet.geografskaDuzina}"></td>
        	</tr>
        	<tr>
        		<td>Najnizi nivo opstosti</td>
        		<td><input type="text" name="opstost1" value="${predmet.opstost1}"></td>
        	</tr>
        	<tr>
        		<td>Srednji nivo opstosti</td>
        		<td><input type="text" name="opstost2" value="${predmet.opstost2}"></td>
        	</tr>
        	<tr>
